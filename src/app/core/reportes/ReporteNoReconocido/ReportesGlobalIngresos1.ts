...
export class ReportesGlobalIngresos1 {
    ...
    genera(arr: any, ifr:any) {
        ...
        pdf.setFontSize(15);
        pdf.text('Balance del periodo', 15, 4.65);
        ...
        autoTable(pdf, {
            ...
            ['Tipo:', 'Global'],
            ['Tipo:', this.array[0][0].Inversionista],
            ...
            didParseCell: function (data) {
                ...
                if (data.row.cells[1].raw == 'Global') {
                    data.cell.styles.fontSize = 13;
                    data.cell.styles.fontStyle = 'bold';
                }
                // console.log(data.row.cells[0])
                if (data.row.cells[0].raw == 'Tipo:' && data.row.cells[0].styles.fontSize == 9) {
        ...
        autoTable(pdf, {
            ...
            ['Saldo:', `${formatCurrency(200000, 'en', '$ ', '', '1.2-4')} MXN`],
        ...
        autoTable(pdf, {
            ...
            styles: { overflow: 'linebreak' },
            head: [['Monto', 'Fecha', 'Status', 'Cliente', 'Fecha']],
            // body: bodyRows(20),
