...
export class ReportesGlobalPrestamos1  {
    ...
    genera(arr: any, ifr:any) {
        ...
        pdf.setFontSize(15);
        pdf.text('Balance del periodo', 15, 3.1);
        ...
        autoTable(pdf, {
            ...
            didParseCell: function (data) {
                ...
                // if (data.row.cells[0].raw == 'Categoría:' && data.row.cells[0].styles.fontSize == 9) {
        ...
        autoTable(pdf, {
            ...
            // ['Ingresos:', `${formatCurrency(this.array[1][0].Retiro_Rendimientos, 'en', '$ ', '', '1.2-4')} MXN`],
            // ['Egresos:', `${formatCurrency(this.array[1][0].Aporte_Capital, 'en', '$ ', '', '1.2-4')} MXN`],
            ['Saldo:', `${ formatCurrency( this.array[1][0].Prestamos, 'en', '$ ', '', '1.2-4') } MXN`],
            ...
            didParseCell: function (data) {
                ...
                if (data.row.cells[0].raw == 'Saldo:' && data.column.index === 0) {
                    data.cell.styles.cellPadding = { top: 0.29, right: 0, bottom: 0.28, left: 0.1763888888888889 };
                }
                
                if (data.row.cells[0].raw == 'Saldo:' && data.column.index === 1) {
                    data.cell.styles.cellPadding = { top: 0.20, right:  0.1763888888888889, bottom: 0.18, left: 0.1763888888888889 };
        ...
        autoTable(pdf, {
            ...
            styles: { overflow: 'linebreak' },
            head: [['Monto', 'Ingreso', 'Status']],
            // body: bodyRows(20),
            body: this.array[2].map((item:any) => [formatCurrency( item.Monto, 'en', '$ ', '', '1.2-4') , this.formatoFechaLatina(item.Fecha), item.Estatus]),
