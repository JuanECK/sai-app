...
export class ReportesIndividualDivisas1 {
    ...
    genera(arr: any, ifr:any) {
        ...
        autoTable(pdf, {
            ...
            body: [['Recepción de capital:', `${formatCurrency(this.array[1][0].recepcionCapital, 'en', '$ ', '', '1.2-4')} MXN`],
                // [ 'Retiro de rendimientos:',`${ formatCurrency( 2000000000000000000000, 'en', '$ ', '', '1.2-4') } MXN` ],
                ['Diferencia cambiaria:', `${formatCurrency(this.array[1][0].diferenciaCambiaria, 'en', '$ ', '', '1.2-4')} MXN`],
                ['Devoluciones:', `${formatCurrency(this.array[1][0].devoluciones, 'en', '$ ', '', '1.2-4')} MXN`],
                // ['Comisiones generadas:', `${formatCurrency(2000, 'en', '$ ', '', '1.2-4')} MXN`],
                [ 'Comisiones generadas:',`${ formatCurrency( this.array[1][0].ComisionesTotales, 'en', '$ ', '', '1.2-4') } MXN` ],
            ],
        ...
        autoTable(pdf, {
            ...
            styles: { overflow: 'linebreak' },
            head: [['Nombre', 'Concepto', 'Comisión', 'Fecha']],
            // body: bodyRows(20),
            body: this.array[2].map((item:any) => [item.Cliente, item.Concepto, formatCurrency( item.Comision, 'en', '$ ', '', '1.2-4'), this.formatoFechaLatina(item.Fecha_Captura)]),
