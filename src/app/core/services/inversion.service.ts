...
export class Inversion {
    ...
    async getCuentas() {
        const response = await fetch(this._http + 'inversion/cargaCuentasLista', {
            method: 'GET',
            headers: {
    ...
    async getHistorico() {
        const response = await fetch(this._http + 'inversion/cargaHistoricoInversion', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            }
    ...
    async setAsignacion( formulario:any ) {
        ...
        const response = await fetch(this._http + 'inversion/asigna', {
            method: 'POST',
            headers: {
                'Content-Type':'application/json'
            },
    ...
    async cargainversionId( id:number ){
        console.log(id)
        const response = await fetch( this._http + 'inversion/cargaInversion',{
            method:'POST',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async busqueda( criterio:string ){
        ...
        const response = await fetch( this._http + 'inversion/busqueda',{
            method:'POST',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async EnviarActualizacio( formularioActualizado: FormGroup, BusquedaID:Array<any> ){
        ...
        if( hayCambios ){
            ...
            const response = await fetch(this._http + 'inversion/actualizaInversion', {
                method: 'POST',
                headers:{
                    'Content-Type':'application/json'
                },
    ...
    async eliminaObservacion( Id:number, estatus:string, usuario:number ){
        ...
        const response = await fetch(this._http + 'inversion/eliminarRegistro', {
            method: 'POST',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async AgregarCuenta(formulario: FormGroup) {
        ...
        const response = await fetch(this._http + 'inversion/agregaInversion', {
            method: 'POST',
            headers:{
                'Content-Type':'application/json'
            },
