...
@Component({
  selector: 'Ventana-Ver-Informacion-MovInmobiliario',
  standalone: true,
            ...
            <table class="table">
              <tbody>
                @for( item of dataModal[0]; track $index ){
                  <tr class="trGris">
                    <th class="thead-th-blod-No-Border ">Id Propiedad</th>
                    <td class="tbody-td-ligth-No-Border ">{{item.propiedad}}</td>
                  </tr>
                  <tr class="">
...
export class VentanaVerInformacionMovInmobiliario implements OnInit {
  constructor(
