...
@Component({
  selector: 'Ventana-Ver-Informacion-MovOficina',
  standalone: true,
            ...
            <table class="table">
              <tbody>
                @for( item of dataModal[0]; track $index ){
                  ...
                  <tr class="trGris">
                    <th class="thead-th-blod-No-Border ">Cuenta de pago</th>
...
export class VentanaVerInformacionMovOficina implements OnInit {
  constructor(
    public servicio: Oficina
  ) { }
