...
@Component({
  selector: 'Ventana-Ver-Informacion-MovDivisas',
  standalone: true,
            ...
            <table class="table">
              <tbody>
                @for( item of dataModal[0]; track $index ){
                  <tr class="">
                    <th class="thead-th-blod-No-Border ">Cliente</th>
                    <td class="tbody-td-ligth-No-Border ">{{item.Cliente}}</td>
                  </tr>
                  <tr class="trGris">
                    <th class="thead-th-blod-No-Border ">Concepto</th>
                    <td class="tbody-td-ligth-No-Border ">{{item.NombreConcepto}}</td>
                  </tr>
                  <tr class="">
              ...
              <div class="divObservaciones">
                ...
                <textarea class="observaciones" name="" id="" rows=0 cols=0 disabled="true" placeholder="Sin observaciones del movimiento">{{dataModal[0][0].Observaciones}}</textarea>
              </div>
          </div>
        </div>
      </div>
...
export class VentanaVerInformacionMovDivisas implements OnInit {
  constructor(
