...
@Component({
  selector: 'Ventana-Ver-Informacion-MovFactura',
  standalone: true,
            ...
            <table class="table">
              <tbody>
                @for( item of dataModal[0]; track $index ){
                  <tr class="trGris">
                    <th class="thead-th-blod-No-Border ">Esquema:</th>
                    <td class="tbody-td-ligth-No-Border ">{{item.Esquema}}</td>
                  </tr>
                  <tr class="">
                    <th class="thead-th-blod-No-Border ">Financiamiento:</th>
                    <td class="tbody-td-ligth-No-Border ">{{getCurrency(item.Financiamiento)}}</td>
                  </tr>
                  <tr class="trGris">
                    <th class="thead-th-blod-No-Border ">Pago de factura:</th>
                    <td class="tbody-td-ligth-No-Border ">{{getCurrency(item.Factura)}}</td>
                  </tr>
                  <tr class="">
                    <th class="thead-th-blod-No-Border ">Pago a comisionista:</th>
                    <td class="tbody-td-ligth-No-Border ">{{getCurrency(item.Comisionista)}}</td>
                  </tr>
                  <tr class="trGris">
                    <th class="thead-th-blod-No-Border ">Comisión Obtenida:</th>
                    <td class="tbody-td-ligth-No-Border ">{{getCurrency(item.Propia)}}</td>
                  </tr>
                  <tr class="">
  ...
  `,
  styleUrl: './cdk-dialog-Vista-info-style.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})

export class VentanaVerInformacionMovFactura implements OnInit {
  constructor(
