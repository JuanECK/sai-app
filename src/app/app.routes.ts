...
export const routes: Routes = [
    ...
    {    path:'', component: LayoutComponent, canActivate: [LoginGuardianService] ,
        children: [
            ...
            { path:'Reportes', component:ReportesIndividualesComponent, canActivate: [isNavHeadNoActiveGuard]},
            { path:'Reportes/Individuales', component:ReportesIndividualesComponent, canActivate: [isModAuthGuard],data:{roles:['Reportes']}},
            { path:'Reportes/Globales', component:ReportesGlobalesComponent, canActivate: [isModAuthGuard],data:{roles:['Reportes']}},
